...
public class PatternArtifactFilterTest {
    ...
    public void testIncludeAndExclude_Null() {
        ...
        DefaultArtifact defaultArtifact = createArtifact1();
    ...
    private DefaultArtifact createArtifact1() {
        DefaultArtifact defaultArtifact = new DefaultArtifact();
        defaultArtifact.setArtifactId("artifact");
        defaultArtifact.setGroupId("org.metaeffekt.core");
        defaultArtifact.setVersion("0.0.1");
