...
public class PreFormattedEscapeUtilsTest {
    ...
    public void xmlEscapeUnspecifiedTagsTest() {
        ...
        Assertions.assertEquals("&lt;code&gt;In modern browsers, the MIME type&lt;navbar&gt;that is sent with the HTML document may&lt;br&gt;affect how the document is initially interpreted.&lt;/navbar&gt;&lt;/code&gt;A document sent with the XHTML&lt;test&gt;MIME type is expected to be well", escapeUtils.xml(input));
    }

    @Test
    public void xmlEscapeKnownBalancedTagsTest() {
        final String input = "<p>syntax errors may cause</p>";
        Assertions.assertEquals("<p>syntax errors may cause</p>", escapeUtils.xml(input));
    }
    ...
    public void xmlEscapeNestedKnownBalancedTagsTest() {
        ...
        Assertions.assertEquals("<p>There are two axes differentiating various variations of HTML as currently specified:<ul><li>SGML-based HTML</li><li>XML-based HTML</li></ul></p>", escapeUtils.xml(input));
    }
    ...
    public void xmlEscapeNestedKnownUnbalanced1TagsTest() {
        ...
        Assertions.assertEquals("<p>There are two axes differentiating various variations of HTML as currently specified:&lt;ul&gt;&lt;li&gt;SGML-based HTML&lt;/li&gt;XML-based HTML&lt;/li&gt;</p>", escapeUtils.xml(input));
    }
    ...
    public void xmlEscapeNestedKnownUnbalanced2TagsTest() {
        ...
        Assertions.assertEquals("There are two axes differentiating various variations of HTML as currently specified:<ul>&lt;li&gt;SGML-based HTML&lt;li&gt;XML-based HTML&lt;/li&gt;</ul>&lt;/p&gt;", escapeUtils.xml(input));
    }

    @Test
    public void xmlEscapeDoubleEscapeCharactersTest() {
        final String input = "&lt;Test&gt;";
        Assertions.assertEquals("&lt;Test&gt;", escapeUtils.xml(input));
    }
    ...
    public void xmlEscapeHeaderHandlingTest() {
        ...
        Assertions.assertEquals("<p><b>To understand the subtle</b></p><p><b>differences between HTML and XHTML</b></p><p><b>it is important to understand</b></p>", escapeUtils.xml(input));
    }
    ...
    public void xmlEscapeHeaderAndRawHeaderHandlingTest() {
        ...
        Assertions.assertEquals("<p><b>To understand the subtle</b></p><p><b>differences <p><b>between</p></b> HTML and XHTML</b></p><p><b>it is important to understand</b></p>", escapeUtils.xml(input));
    }
    ...
    public void xmlEscapeHeaderAndRawHeaderHandlingUnbalancedTest() {
        ...
        Assertions.assertEquals("<p><b>To understand the subtle</b></p><p><b>differences <p>&lt;b&gt;between</p>&lt;/b&gt; HTML and&lt;/b&gt; XHTML</b></p><p><b>it is important to understand</b></p>", escapeUtils.xml(input));
    }
