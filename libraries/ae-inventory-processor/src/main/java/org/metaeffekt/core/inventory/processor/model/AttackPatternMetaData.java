...
public class AttackPatternMetaData extends AbstractModelBase {

    public AttackPatternMetaData(AbstractModelBase baseModelInstance) {
        super(baseModelInstance);
    }

    public AttackPatternMetaData() {
    }
    ...
    public enum Attribute implements AbstractModelBase.Attribute {
        ...
        public static AttackPatternMetaData.Attribute match(String key) {
            for (AttackPatternMetaData.Attribute a : values()) {
