...
public class WeaknessMetaData extends AbstractModelBase {

    public WeaknessMetaData(AbstractModelBase baseModelInstance) {
        super(baseModelInstance);
    }

    public WeaknessMetaData() {
    }
    ...
    public enum Attribute implements AbstractModelBase.Attribute {
        ...
        public static WeaknessMetaData.Attribute match(String key) {
            for (WeaknessMetaData.Attribute a : values()) {
