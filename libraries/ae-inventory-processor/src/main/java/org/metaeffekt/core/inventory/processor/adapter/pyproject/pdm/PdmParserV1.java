 ...
 */
public class PdmParserV1 extends AbstractPdmParser {
    @Override
    ...
    protected List<UnresolvedModule> extractRuntimeDependencies(JsonNode root) {
        return extractDirectDependencies(root, "/project/dependencies");
    }

    @Override
    protected List<UnresolvedModule> extractDevelopmentDependencies(JsonNode root) {
        return extractDirectDependencies(root, "/tool/pdm/dev-dependencies/dev");
    }
}
