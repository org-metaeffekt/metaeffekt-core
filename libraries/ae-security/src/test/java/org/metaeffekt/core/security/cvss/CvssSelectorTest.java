...
public class CvssSelectorTest {
    ...
    public void defaultCvssSelectorTest() {
        ...
        assertEquals("CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H", CVSS_SELECTOR_INITIAL.selectVector(Arrays.asList(vector1, vector2)).toString());
        assertEquals("CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H/MAV:A/MC:N/MI:N", CVSS_SELECTOR_CONTEXT.selectVector(Arrays.asList(vector1, vector2)).toString());
    }
    ...
    public void applyMetricLowerHigherSelectorTest() {
        ...
        assertEquals("CVSS:4.0/AV:L/AC:H/AT:N/PR:N/UI:N/VC:N/VI:L/VA:L/SC:L/SI:L/SA:L/MAT:P/MPR:L/MUI:N/MVC:N/MVI:L/MVA:N/MSC:N", CVSS_SELECTOR_CONTEXT.selectVector(Arrays.asList(input, modificationLower)).toString());
        assertEquals("CVSS:4.0/AV:L/AC:H/AT:N/PR:N/UI:N/VC:N/VI:L/VA:L/SC:L/SI:L/SA:L/MAV:A/MAC:L/MUI:N/MVC:N/MVI:L/MSA:S", CVSS_SELECTOR_CONTEXT.selectVector(Arrays.asList(input, modificationHigher)).toString());
    }
}
