...
export CORE_BRANCH_VERSION=HEAD-SNAPSHOT
...
mvn pre-clean -Pupdate-versions,dev -Dae.core.version=$1 -N -Dae.core.version_last=0.157.2
...
mvn pre-clean -P update-versions -Dae.core.version=$CORE_BRANCH_VERSION -N -Dae.core.version_last=$1
