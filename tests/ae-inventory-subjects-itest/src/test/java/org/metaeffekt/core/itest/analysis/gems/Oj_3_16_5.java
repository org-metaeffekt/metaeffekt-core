...
public class Oj_3_16_5 extends AbstractCompositionAnalysisTest{

    @BeforeClass
    public static void prepare() {
        testSetup = new UrlBasedTestSetup()
                .setSource("https://rubygems.org/downloads/oj-3.16.5.gem")
                .setSha256Hash("1e74311cd86a21437703762eb3757ecbe3808058164ff2259ec2367e21f8067c")
                .setName(Oj_3_16_5.class.getName());
    }
    ...
    public void assertContent() throws Exception {
        ...
        artifactList.with(attributeValue(ID, "oj-3.16.5"),
