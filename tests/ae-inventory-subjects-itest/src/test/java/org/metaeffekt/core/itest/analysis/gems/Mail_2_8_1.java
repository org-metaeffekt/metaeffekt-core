...
public class Mail_2_8_1 extends AbstractCompositionAnalysisTest{

    @BeforeClass
    public static void prepare() {
        testSetup = new UrlBasedTestSetup()
                .setSource("https://rubygems.org/downloads/mail-2.8.1.gem")
                .setSha256Hash("ec3b9fadcf2b3755c78785cb17bc9a0ca9ee9857108a64b6f5cfc9c0b5bfc9ad")
                .setName(Mail_2_8_1.class.getName());
    }
    ...
    public void assertContent() throws Exception {
        ...
        artifactList.with(attributeValue(ID, "mail-2.8.1"),
