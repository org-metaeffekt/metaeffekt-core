...
public class Redis_5_2_0 extends AbstractCompositionAnalysisTest{

    @BeforeClass
    public static void prepare() {
        testSetup = new UrlBasedTestSetup()
                .setSource("https://rubygems.org/downloads/redis-5.2.0.gem")
                .setSha256Hash("336b975a56b166c6af4d4a1026c71dbed429ba5dc949aac373ef2fded07936b4")
                .setName(Redis_5_2_0.class.getName());
    }
    ...
    public void assertContent() throws Exception {
        ...
        artifactList.with(attributeValue(ID, "redis-5.2.0"),
