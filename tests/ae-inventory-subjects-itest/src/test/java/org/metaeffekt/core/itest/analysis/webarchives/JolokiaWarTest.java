...
public class JolokiaWarTest extends AbstractCompositionAnalysisTest {
    ...
    public void testCompositionAnalysis() throws Exception {
        ...
        analysis.selectArtifacts(startsWith(ID, "jolokia")).hasSizeOf(5); // currently the jolokia-war-1.7.2.war is duplicated
        ...
        analysis.selectArtifacts(attributeValue(VERSION, "1.7.2")).hasSizeOf(5); // currently the jolokia-war-1.7.2.war is duplicated
