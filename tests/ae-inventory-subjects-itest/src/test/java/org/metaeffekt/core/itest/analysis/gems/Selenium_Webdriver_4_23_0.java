...
public class Selenium_Webdriver_4_23_0 extends AbstractCompositionAnalysisTest{
    ...
    public static void prepare() {
        testSetup = new UrlBasedTestSetup()
                .setSource("https://rubygems.org/downloads/selenium-webdriver-4.23.0.gem")
                .setSha256Hash("490aeddee879cfea58a4db6628338d60a905bc56cd5e1a60dfbaa9090a19b801")
                .setName(Selenium_Webdriver_4_23_0.class.getName());
    }
