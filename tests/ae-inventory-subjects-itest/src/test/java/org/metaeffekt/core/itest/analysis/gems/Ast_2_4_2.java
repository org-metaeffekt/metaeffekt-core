...
public class Ast_2_4_2 extends AbstractCompositionAnalysisTest{

    @BeforeClass
    public static void prepare() {
        testSetup = new UrlBasedTestSetup()
                .setSource("https://rubygems.org/downloads/ast-2.4.2.gem")
                .setSha256Hash("1e280232e6a33754cde542bc5ef85520b74db2aac73ec14acef453784447cc12")
                .setName(Ast_2_4_2.class.getName());
    }
    ...
    public void assertContent() throws Exception {
        ...
        artifactList.with(attributeValue(ID, "ast-2.4.2"),
