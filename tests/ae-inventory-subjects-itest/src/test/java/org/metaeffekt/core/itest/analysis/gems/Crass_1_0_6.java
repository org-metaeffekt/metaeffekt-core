...
public class Crass_1_0_6 extends AbstractCompositionAnalysisTest{

    @BeforeClass
    public static void prepare() {
        testSetup = new UrlBasedTestSetup()
                .setSource("https://rubygems.org/downloads/crass-1.0.6.gem")
                .setSha256Hash("dc516022a56e7b3b156099abc81b6d2b08ea1ed12676ac7a5657617f012bd45d")
                .setName(Crass_1_0_6.class.getName());
    }
    ...
    public void assertContent() throws Exception {
        ...
        artifactList.with(attributeValue(ID, "crass-1.0.6"),
