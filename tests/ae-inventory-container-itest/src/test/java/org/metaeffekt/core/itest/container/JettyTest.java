...
public class JettyTest extends AbstractCompositionAnalysisTest {
    ...
    public void testComponentPatterns() throws Exception {
        ...
        // FIXME: md5sums, list files and so on are used by several artifacts
        Assert.assertEquals(27, duplicateList.getRemainingDuplicates().size());
    ...
    public void testContainerStructure() throws Exception {
        ...
        analysis.selectArtifacts(containsToken(COMPONENT_SOURCE_TYPE, "dpkg")).hasSizeOf(135);
        analysis.selectArtifacts(containsToken(COMPONENT_SOURCE_TYPE, "jar-module")).hasSizeOf(68);
        ...
        // FIXME: some files are not covered
        analysis.selectArtifacts(AttributeValue.attributeValue(TYPE, null)).hasSizeOf(211);
