...
public class CentOSFileFilterTest extends AbstractContainerFileFilterTest {
    ...
    public void filterFileList() throws IOException {
        ...
        excludePatterns.add("/var/lib/rpm/**/*");
        ...
        assertFilesFiltered(analysisDir, excludePatterns, 10);
    }
